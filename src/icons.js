...
import { createElement, Info, Pencil, Plus, Search, Link2, FilePlus2, BookOpen, ChevronRight, ChevronDown,
  Trash2, ExternalLink, Copy, Check, TriangleAlert, KeyRound, Ellipsis, SlidersHorizontal, X, Code2, StickyNote, Columns3, ArrowRight } from "lucide";
...
const NODES = { info:Info, pencil:Pencil, plus:Plus, search:Search, link:Link2, "file-plus":FilePlus2, book:BookOpen,
  ...
  alert:TriangleAlert, key:KeyRound, more:Ellipsis, sliders:SlidersHorizontal, x:X, code:Code2, note:StickyNote, columns:Columns3, arrow:ArrowRight };
const cache = new Map();
